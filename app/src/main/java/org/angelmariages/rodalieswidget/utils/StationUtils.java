...
public final class StationUtils {
	...
	public static final LinkedHashMap<Integer, String> nucli50 = new LinkedHashMap<Integer, String>(){{
		put(72400, "Aeroport");
	...
	public static final LinkedHashMap<Integer, String> nucli20 = new LinkedHashMap<Integer, String>(){{
		put(15205, "Ablaña");
		put(16403, "Aviles");
		put(16006, "Barros");
	...
	public static final LinkedHashMap<Integer, String> nucli60 = new LinkedHashMap<Integer, String>(){{
		put(13200, "Abando");
	...
	public static final LinkedHashMap<Integer, String> nucli31 = new LinkedHashMap<Integer, String>(){{
	...
	public static final LinkedHashMap<Integer, String> nucli10 = new LinkedHashMap<Integer, String>(){{
	...
	public static final LinkedHashMap<Integer, String> nucli32 = new LinkedHashMap<Integer, String>(){{
	...
	/*public static final LinkedHashMap<Integer, String> nucli41 = new LinkedHashMap<Integer, String>(){{
		put(07004, "Aguilas");
	...
	public static final LinkedHashMap<Integer, String> nucli62 = new LinkedHashMap<Integer, String>(){{
	...
	public static final LinkedHashMap<Integer, String> nucli61 = new LinkedHashMap<Integer, String>(){{
	...
	public static final LinkedHashMap<Integer, String> nucli30 = new LinkedHashMap<Integer, String>(){{
	...
	public static final LinkedHashMap<Integer, String> nucli40 = new LinkedHashMap<Integer, String>(){{
		put(65005, "Albuixech");
		put(66211, "Aldaia");
	...
	/*public static final LinkedHashMap<Integer, String> nucli70 = new LinkedHashMap<Integer, String>(){{
		put(70800, "Casetas");
	...
	public static int getIDFromName(String stationName) {
		if (nucli50.containsValue(stationName)) {
			for (Integer stationID : nucli50.keySet()) {
				if (nucli50.get(stationID).equalsIgnoreCase(stationName))
					return stationID;
			}
		}
		return -1;
	...
	public static String getNameFromID(int stationID) {
		return nucli50.containsKey(stationID) ? nucli50.get(stationID) : null;
	}
